...
import { Coffee, Compass, Key, ShieldCheck, MapPin, Sparkles, ChevronRight } from 'lucide-react';

interface ClientJourneyProps {
  onOpenBooking: () => void;
}

export const ClientJourney: React.FC<ClientJourneyProps> = ({ onOpenBooking }) => {
  const steps = [
    {
      number: 'I',
  ...
  return (
    <section
      id="journey"
      className="py-24 bg-[#0d0e13] border-t border-[#1d202b] relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end border-b border-[#212531] pb-10">
          <div className="lg:col-span-7">
            ...
            <h2 className="font-serif-luxury text-3xl sm:text-4xl md:text-5xl text-[#f5f2eb] leading-tight">
            ...
            return (
              ...
              >
                ...
                <div className="lg:col-span-5 space-y-4 relative z-10">
                  ...
                  <h3 className="font-serif-luxury text-2xl sm:text-3xl text-[#f4efe5] pr-6">
                    {step.title}
                  </h3>
        ...
        <div className="p-8 sm:p-10 bg-gradient-to-r from-[#171a22] to-[#12141b] border border-[#282d3b] flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            <h4 className="font-serif-luxury text-xl sm:text-2xl text-[#f5f2eb]">
